...
class PrivacyController extends Controller
{
    ...
    {
        return $this->sendResponse($this->privacyRepository->restore($id), "", 200);
    }
    ...
    {
        return $this->sendResponse($this->privacyRepository->restoreAll(), "", 200);
    }
    ...
    {
        return $this->sendResponse($this->privacyRepository->forceDelete($id), "", 200);
    }
    ...
    {
        return $this->sendResponse($this->privacyRepository->forceDeleteAll(), "", 200);
    }
}
