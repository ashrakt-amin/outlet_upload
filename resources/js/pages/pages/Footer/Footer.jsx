...
const Footer = () => {
    return (
        ...
        <div className="manger-div mt-3">
            <h1 className="text-center font-semibold">Team Leader:</h1>
            <h1 className="text-center font-bold">Ziyad Mohammad Medhat</h1>
        </div>

            <div className="developers-div">
                <h1 className="font-bold p-1 m-1">Created By:</h1>
                <h1 className="text-lg p-1 m-1">
                    Ahmad Mohammad Sheta (BackEnd Developer)
                </h1>
                <h1 className="text-lg p-1 m-1">
                    Youssef Mahmoud (FrontEnd Developer)
                </h1>
            </div>
