    ...
    const adjustNow = async () => {
        try {
            const res = await axios.put(
                `${process.env.MIX_APP_URL}/api/importers/${activityId}`,
                { name: acivityName }
            );
...
export default AllImportedCompanies;
