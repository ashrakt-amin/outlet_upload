    ...
    const adjustNow = async () => {
        try {
            const res = await axios.put(
                `${process.env.MIX_APP_URL}/api/companies/${activityId}`,
                { name: acivityName }
            );
...
export default AllDistributeCompanies;
