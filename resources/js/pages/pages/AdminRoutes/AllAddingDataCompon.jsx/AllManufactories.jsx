    ...
    const adjustNow = async () => {
        try {
            const res = await axios.put(
                `${process.env.MIX_APP_URL}/api/manufactories/${activityId}`,
                { name: acivityName }
            );
...
export default AllManufactories;
